...
class Pixova_Lite_Widget_About extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'A widget that displays about text & social media counts. Designed for footer', 'bootbase' ),
		);
		...
		parent::__construct( 'pixova_lite_widget_about', __( '[MT] - About', 'bootbase' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<div class="macho-meta">
		  ...
		  <p>
			...
			<label for="<?php echo $this->get_field_id( 'show_title' ); ?>"><?php _e( 'Show widget title?', 'bootbase' ); ?></label>
		  </p>

			<p>
				<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'bootbase' ); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'about_text' ); ?>"><?php _e( 'About us', 'bootbase' ); ?></label>
